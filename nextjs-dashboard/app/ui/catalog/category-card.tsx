...
export default function CategoryCard() {
  const categories = [
    ...
    },
    {
      ...
      description:
        "Inspired paintings of some of the worls greatest landscapes. Embrace the beauty of Gods creation. ",
      id: "4",
    },
    {
      name: "Woods",
      ...
      description:
        "Beautiful wood craft for your home and office decoration.",
      id: "5",
    },
  ];
  //   const sellers = [];
